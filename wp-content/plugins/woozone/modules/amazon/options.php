...
function __WooZone_attributes_clean_duplicate( $istab = '' ) {
	...
	$html[] = '<div class="panel-body WooZone-panel-body WooZone-form-row attr-clean-duplicate' . ($istab!='' ? ' '.$istab : '') . '">';
...
function __WooZone_category_slug_clean_duplicate( $istab = '' ) {
	...
	$html[] = '<div class="panel-body WooZone-panel-body WooZone-form-row category-slug-clean-duplicate' . ($istab!='' ? ' '.$istab : '') . '">';
...
function __WooZone_clean_orphaned_amz_meta( $istab = '' ) {
	...
	$html[] = '<div class="panel-body WooZone-panel-body WooZone-form-row clean_orphaned_amz_meta' . ($istab!='' ? ' '.$istab : '') . '">';
...
function __WooZone_delete_zeropriced_products( $istab = '' ) {
	...
	$html[] = '<div class="panel-body WooZone-panel-body WooZone-form-row  delete_zeropriced_products' . ($istab!='' ? ' '.$istab : '') . '">';
...
function __WooZone_clean_orphaned_prod_assets( $istab = '' ) {
	...
	$html[] = '<div class="panel-body WooZone-panel-body WooZone-form-row clean_orphaned_prod_assets' . ($istab!='' ? ' '.$istab : '') . '">';

	$html[] = '<label class="WooZone-form-label" for="clean_orphaned_prod_assets">' . __('Clean orphaned Amz Products Assets:', $WooZone->localizationName) . '</label>';
...
function __WooZone_fix_product_attributes( $istab = '' ) {
	...
	$html[] = '<div class="panel-body WooZone-panel-body WooZone-form-row fix-product-attributes' . ($istab!='' ? ' '.$istab : '') . '">';
...
function __WooZone_fix_node_childrens( $istab = '' ) {
	...
	$html[] = '<div class="panel-body WooZone-panel-body WooZone-form-row fix-node-childrens' . ($istab!='' ? ' '.$istab : '') . '">';
...
function __WooZone_fix_issue_request_amazon( $istab = '' ) {
	...
	$html[] = '<div class="panel-body WooZone-panel-body WooZone-form-row fix_issue_request_amazon2' . ($istab!='' ? ' '.$istab : '') . '">';
...
function __WooZone_fix_issue_sync( $istab = '' ) {
	...
	$html[] = '<div class="WooZone-form-row fix_issue_sync-wrapp' . ($istab!='' ? ' '.$istab : '') . '" style="line-height: 35px;">';
...
function __WooZone_reset_products_stats( $istab = '' ) {
	...
	$html[] = '<div class="panel-body WooZone-panel-body WooZone-form-row reset_products_stats2' . ($istab!='' ? ' '.$istab : '') . '">';
...
function __WooZone_options_prefix_change( $istab = '' ) {
	...
	$html[] = '<div class="panel-body WooZone-panel-body WooZone-form-row options_prefix_change2' . ($istab!='' ? ' '.$istab : '') . '">';
...
function __WooZone_unblock_cron( $istab = '' ) {
	...
	$html[] = '<div class="panel-body WooZone-panel-body WooZone-form-row unblock_cron' . ($istab!='' ? ' '.$istab : '') . '">';
