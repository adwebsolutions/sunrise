...
if(!function_exists('etheme_theme_styles')) {
    function etheme_theme_styles() {
        if ( !is_admin() ) {
        	wp_enqueue_style('mycustom-style', get_template_directory_uri() . '/mycustom-style.css');
        	...
        	wp_register_script( 'mycustomjs', get_template_directory_uri() . '/js/mycustomjs.js', array('jquery'), '', true);
